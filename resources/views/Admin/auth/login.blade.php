...
<div class="container">
    ...
    <div class="welcome-container">
        <h1 class="heading-secondary">مرحبا بعودتك <span class="md" style="color: #02046f">{{($setting->title) ?? 'تطبيق ايجارات مصر'}}</span></h1>
        <img src="{{asset('assets/admin/images/house.gif')}}" alt="login" style="max-height: 300px;mix-blend-mode: multiply ; width: 300px; border-radius: 50%"  >
    </div>
</div>
